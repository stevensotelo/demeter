# -*- coding: utf-8 -*-
"""Joint Intent - Slot Demeter.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WersOGKUQs8nIrl_CoxTLaU9YY0-pUyv
"""
...
print(encoded_train["attention_masks"][0])
print(slot_train[0])
#print(slot_valid)
...
def create_model(intent_num_labels, slot_num_labels):
  ...
  in_id = keras.layers.Input(shape=(None,), name='input_ids', dtype='int32')
  in_mask = keras.layers.Input(shape=(None,), name='attention_masks', dtype='int32')
  #in_segment = keras.layers.Input(shape=(None,), name='segment_ids', dtype='int32')  
  ...
  intents_drop = Dropout(rate=0.1)(bert_output[1])  
  ...
  slots_drop = Dropout(rate=0.1)(bert_output[0])
  slots_output = Dense(slot_num_labels, activation='softmax', name='slots_tagger')(slots_drop)
  #slots_output = TimeDistributed(Dense(slot_num_labels, activation='softmax'))(slots_drop)
  #slots_output = Multiply(name='slots_tagger')([slots_output, in_mask])
  


  #dropout = Dropout(0.1)  
  #intent_classifier = Dense(intent_num_labels, name="intent_classifier")
  #slot_classifier = Dense(slot_num_labels, name="slot_classifier")

  #bert_sequence_output = dropout(bert_sequence_output, training = True)
  #slots_output = slot_classifier(sequence_output)
  
  #bert_pooled_output = dropout(bert_pooled_output, training = True)
  #intents_fc = intent_classifier(bert_pooled_output)
  
  model = keras.Model(inputs=bert_inputs, outputs=[slots_output, intents_fc])
  return model
...
show_predictions("Cuando puedo sembrar arroz en Cali de precipitación", tokenizer, model2, intent_names, slot_names)
...
nlu("Pronostico climatico de cali",tokenizer, model2, intent_names, slot_names)